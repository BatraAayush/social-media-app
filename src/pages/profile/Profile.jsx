                  ...
                  <div className="edit-profile">
                    <div className="container-4">
                      ...
                      <button
                        className="dark-btn"
                        onClick={() => {
                          editProfileHandler(newUserDetails);
                    ...
                    <div className="field">
                      ...
                      <input
                        ...
                        defaultValue={newUserDetails.firstName}
                        type="text"
                      />
                    </div>
                    <div className="field">
                      ...
                      <input
                        ...
                        defaultValue={newUserDetails.lastName}
                        type="text"
                      />
                    </div>
                    <div className="field">
                      ...
                      <input
                        ...
                        defaultValue={newUserDetails.bio}
                        type="text"
                      />
                    </div>
                    <div className="field">
                      ...
                      <input
                        ...
                        defaultValue={newUserDetails.website}
                        type="text"
                      />
                    </div>
                    <div className="field">
